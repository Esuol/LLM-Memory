  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-2 text-gray-900">多 Agent 协作 (Plan-Execute)</h1>
        <p className="text-gray-700 mb-6">规划 Agent 拆解任务 → 执行 Agent 并行执行 → 汇总结果</p>

        <div className="bg-white rounded-lg shadow p-6 mb-4">
          <h2 className="font-semibold mb-2 text-gray-900">执行日志</h2>
